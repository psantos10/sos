...
ActiveRecord::Schema.define(version: 2020_06_20_172606) do
  ...
  create_table "volunteer_helps", force: :cascade do |t|
    ...
    t.index ["volunteer_id", "help_id"], name: "index_volunteer_helps_on_volunteer_id_and_help_id", unique: true
